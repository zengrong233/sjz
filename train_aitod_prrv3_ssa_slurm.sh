...
# AI-TOD 训练脚本（4.13）
# 默认口径:
#   - 结构: YOLO11-HFAMPAN-AsDDet-NWD-SmallObject-PRR-v3-SSA.yaml
#   - 模式: full
#   - 数据: data_AI-TOD_server2.yaml
#   - 初始权重: yolo11n.pt
#
# 用法:
#   sbatch train_aitod_prrv3_ssa_slurm.sh
#
# 可选环境变量覆盖:
#   PROJECT_DIR=/share/home/u2415363072/4.13/ultralyticsPro--YOLO11
#   CONDA_ENV=yolov11_py310
#   CFG_FILE=YOLO11-HFAMPAN-AsDDet-NWD-SmallObject-PRR-v3-SSA.yaml
#   DATA_YAML=data_AI-TOD_server2.yaml
#   WEIGHTS_PATH=yolo11n.pt
#   TRAINER_MODE=full

PROJECT_DIR="${PROJECT_DIR:-/share/home/u2415363072/4.13/ultralyticsPro--YOLO11}"
CONDA_ENV="${CONDA_ENV:-yolov11_py310}"
CFG_FILE="${CFG_FILE:-YOLO11-HFAMPAN-AsDDet-NWD-SmallObject-PRR-v3-SSA.yaml}"
