...
# USOD 训练脚本（4.15, P2 精简版）
# 默认口径:
#   - 结构: YOLO11-HFAMPAN-AsDDet-NWD-SmallObject-PRR-v3-SSA-P2.yaml
#   - 模式: full
#   - 数据: data_USOD_server2.yaml
#   - 初始权重: yolo11n.pt
#
# 用法:
#   sbatch train_usod_prrv3_ssa_p2_slurm.sh
#
# 可选环境变量覆盖:
#   PROJECT_DIR=/share/home/u2415363072/4.15/ultralyticsPro--YOLO11
#   CONDA_ENV=yolov11_py310
#   CFG_FILE=YOLO11-HFAMPAN-AsDDet-NWD-SmallObject-PRR-v3-SSA-P2.yaml
...
CFG_FILE="${CFG_FILE:-YOLO11-HFAMPAN-AsDDet-NWD-SmallObject-PRR-v3-SSA-P2.yaml}"
