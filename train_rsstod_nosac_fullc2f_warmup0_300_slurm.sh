...
PROJECT_OUT="runs/rsstod_p1_nosac_fullc2f_warmup0_300"
RUN_NAME="rsstod_nosac_fullc2f_warmup0_no_p3fb_300_${SLURM_JOB_ID}"
...
echo "实验: RS-STOD NoSAC-FullC2f warmup=0 no_p3fb 300epoch"
echo "============================================"
